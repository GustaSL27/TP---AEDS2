...
TipoArvore CriaNoExt(TipoChave palavra); // Funcao que cria um no externo que armazena uma palavra
void Pesquisa(TipoChave palavra, TipoArvore t);
TipoArvore InsereEntre(TipoChave palavra, TipoArvore *t, int i); // A insereEntre é utilizada depois que achou a posicao que difere as palavras
void Insere(TipoChave palavra, TipoArvore *t); // A funcao que faz a inserção.
